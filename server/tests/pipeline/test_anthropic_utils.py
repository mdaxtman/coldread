...
def test_get_anthropic_client_returns_singleton():
...
def test_get_anthropic_client_initializes_with_api_key():
...
def test_extract_tool_response_returns_tool_input():
...
def test_extract_tool_response_raises_on_missing_tool():
